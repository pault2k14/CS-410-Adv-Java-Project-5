function apptbook(){
  ...
  apptbook.__sendStats = sendStats;
  apptbook.__moduleName = $intern_4;
  apptbook.__errFn = null;
  apptbook.__moduleBase = $intern_6;
  apptbook.__softPermutationId = $intern_7;
  apptbook.__computePropValue = null;
  apptbook.__getPropMap = null;
  apptbook.__installRunAsyncCode = function(){
  }
  ;
  apptbook.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  apptbook.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  apptbook.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  apptbook.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[apptbook.__softPermutationId];
    ...
    function installCode(code_0){
      ...
      if (apptbook.__errFn) {
        script.onerror = function(){
          apptbook.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  apptbook.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  apptbook.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    apptbook.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return apptbook.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    apptbook.__getPropMap = function(){
      var result = {};
    ...
    ;
    apptbook.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = apptbook.__getPropMap;
    ...
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_55], $intern_68);
    ...
    apptbook.__softPermutationId = softPermutationId;
  ...
  processMetas();
  apptbook.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = apptbook.__moduleBase;
